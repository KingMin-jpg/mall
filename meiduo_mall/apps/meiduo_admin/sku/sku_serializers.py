...
class SKUSerializers(serializers.ModelSerializer):
    ...
    def create(self, validated_data):
        ...
        try:
            ...
            raise serializers.ValidationError("数据库入库失败")
        else:
...
class SKUCategorySerializers(serializers.ModelSerializer):
    class Meta:
        model = GoodsCategory
        fields = ['id', 'name']
...
class GoodSpecsSerializer(serializers.ModelSerializer):
    ...
    # options = serializers.PrimaryKeyRelatedField(read_only=True, many=True)
