...
from meiduo_mall.apps.users import apps
from meiduo_mall.apps.users.apps import UsersConfig
...
SECRET_KEY = '$=q37#r!&$ezs+p!0bl+ak+d(7y%n!#mj2)+gw=1_ubx109qaz'
...
# FDFS配置
BASE_URL = 'http://192.168.71.128:8888/'
DEFAULT_FILE_STORAGE = 'meiduo_mall.utils.fdfs.my_filestorage.MyFileStorage'
FDFS_CONFIG = os.path.join(BASE_DIR, r"utils\fdfs\client.conf")
...
# 支付宝配置
ALIPAY_PUBLIC_KEY = os.path.join(BASE_DIR, 'utils/keys/alipay_public_key.pem')
APP_PRIVATE_KEY = os.path.join(BASE_DIR, 'utils/keys/app_private_key.pem')
...
CRONJOBS = [
    # 每1分钟生成一次首页静态文件
    # 五颗星含义, 分表表示: 分,时,日,月,周, 参数2: 需要执行的任务,  参数3: 写入的日志路径
